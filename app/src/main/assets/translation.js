...
function trans_localize(lang){
	...
	if(lang == 'ja' || lang == 'jp'){ // Japanese
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', '画11: ただの黒い画面');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', '画12: ただの赤い画面');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', '画13: ただの緑の画面');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', '画14: ただの青の画面');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', '图11：只是黑屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', '图12：只是红屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', '图13: 只是绿屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', '图14: 只是蓝屏');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', '圖11: 只是黑屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', '圖12: 只是紅屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', '圖13: 只是綠屏');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', '圖14: 只是藍屏');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', 'pic11: 그냥 검은 화면');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', 'pic12: 그냥 빨간 화면');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', 'pic13: 그냥 녹색 화면');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', 'pic14: 그냥 파란색 화면');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', 'pic11: Solo uno schermo nero');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', 'pic12: Solo uno schermo rosso');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', 'pic13: Solo uno schermo verde');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', 'pic14: Solo una schermata blu');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', 'pic11: Nur ein schwarzer Bildschirm');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', 'pic12: Nur ein roter Bildschirm');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', 'pic13: Nur ein Greenscreen');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', 'pic14: Nur ein Bluescreen');
		...
		trans_setSelectOptionText(sai_id_select_pic_type, '11', 'pic11: Just a black screen');
		trans_setSelectOptionText(sai_id_select_pic_type, '12', 'pic12: Just a red screen');
		trans_setSelectOptionText(sai_id_select_pic_type, '13', 'pic13: Just a green screen');
		trans_setSelectOptionText(sai_id_select_pic_type, '14', 'pic14: Just a blue screen');
